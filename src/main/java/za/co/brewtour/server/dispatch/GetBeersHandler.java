...
/**
 * Handler to fetch a list of beers. Binds to {@code GetBeersAction.class} in
 * ctor.
 * 
 * @author Ivan Fourie
 */
public class GetBeersHandler extends AbstractActionHandler<GetBeersAction, GetBeersResult> {
	...
	private List<BeerDto> getBeers() {
		...
		beerList.add(new BeerDto(
				...
				"Brewers &amp; Union", "http://www.gabrielcollective.com/beast/beast.html", "Cape Town",
				"Strong Lager", "6.5%", "static/beer_beast_of_the_deep.png"));
		...
		beerList.add(new BeerDto(
				...
				"Boston Breweries", "http://www.bostonbreweries.co.za", "Paarden Eiland, Cape Town", "Amber Ale",
				"3.5%", "static/beer_whale_tale_ale.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Boston Breweries", "http://www.bostonbreweries.co.za", "Paarden Eiland, Cape Town", "Pumkpin Ale",
				"5%", "static/beer_vanhunks_pumkin_ale.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Boston Breweries", "http://www.bostonbreweries.co.za", "Paarden Eiland, Cape Town", "Pale Lager",
				"4.5%", "static/beer_naked_mexican.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Boston Breweries", "http://www.bostonbreweries.co.za", "Paarden Eiland, Cape Town", "Hefeweizen",
				"5%", "static/beer_johnny_gold_weiss.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Boston Breweries", "http://www.bostonbreweries.co.za", "Paarden Eiland, Cape Town",
				"American Strong Ale", "10%", "static/beer_hazzard_ten_ale.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Boston Breweries", "http://www.bostonbreweries.co.za", "Paarden Eiland, Cape Town", "Premium Lager",
				"4%", "static/beer_boston_premium_lager.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Jack Black", "http://www.jackblackbeer.com", "Woodstock, Cape Town", "Premium Lager", "5%",
		...
		beerList.add(new BeerDto(
				...
				"Jack Black", "http://www.jackblackbeer.com", "Woodstock, Cape Town", "Pilsner", "5.2%",
				"static/beer_jack_black_lager.jpg"));
		...
		beerList.add(new BeerDto(
				...
				"Jack Black", "http://www.jackblackbeer.com", "Woodstock, Cape Town", "Pale Ale", "4.5",
				"static/beer_jack_black_lager.jpg"));
