 ...
 * @author Ivan Fourie
 */
public class ImageAdminPresenter extends Presenter<ImageAdminPresenter.MyView, ImageAdminPresenter.MyProxy> {
   /**
    * {@link ImageAdminPresenter}'s proxy.
    */
   @ProxyStandard
   @NameToken(NameTokens.imageAdmin)
   public interface MyProxy extends Proxy<ImageAdminPresenter>, Place {
   }

   /**
    * {@link ImageAdminPresenter}'s view.
    */
   ...
   @Inject
   public ImageAdminPresenter(EventBus eventBus, MyView view, MyProxy proxy, PlaceManager placeManager) {
